...
object CardsCompanion {
    ...
    const val DEFAULT_CARD_ANIMATION_DELAY = 50L
    const val FIRST_CARD_SCALE = 0.9f
    const val SECOND_CARD_SCALE = 0.95f
    const val DEFAULT_SCALE = 1f
    const val VERTICAL_CARD_PADDING = 120f
    val DEFAULT_OFFSET = 0f to 0f
}